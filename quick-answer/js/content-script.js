  ...
  function(e) {
    if (
      window.location.href.indexOf(
        "https://newton.meishakeji.com/game/coin/earn/knowledge/klques"
      ) == -1
    )
      return;
    ...
    if (!e.data) return;
    shuati_flag = true;
    Array.from(document.querySelectorAll(".shuati-btn")).forEach(
...
chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
  ...
  if (
    ...
    window.location.href =
      "https://newton.meishakeji.com/game/coin/earn/knowledge/townList";
  } else {
    let ele = document.querySelector(".shuati");
    if (ele) {
